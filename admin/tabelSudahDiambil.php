...
<div class="row" >
	<div class="col-md-12">
		<h4 style="font-family: Ad Hoc; text-align: center; background-color: #3b90ad; padding: 10px; color: white;">DAFTAR Pengajuan Sudah Diambil </h4>
	</div>
</div>
...
<div class="prg">
	<table id="tabPengajuan">
		...
		<tbody>
			<?php foreach($pengajuan->getDataSudahDiambil() as $data) : ?>
				<tr>				
